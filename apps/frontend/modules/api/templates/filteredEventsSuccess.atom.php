...
<link href="<?php echo url_for('@api_filteredEvents?sf_format=atom', true) . '?' . $extraArguments ?>" rel="self"/>
<link href="<?php echo url_for('@homepage', true) ?>"/>
<updated><?php echo gmstrftime('%Y-%m-%dT%H:%M:%SZ', $latestUpdate) ?></updated>
<author>
  <name><?php echo __('Event calendar') ?></name>
</author>
<id><?php echo sha1(url_for('@api_filteredEvents?sf_format=atom', true) . '?' . $extraArguments) ?></id>
